...
//   return (
//     <div className="min-h-screen py-8 mx-12">
//       <h1 className="text-3xl font-bold text-center mb-6">Manage Testimonials</h1>

//       <div className="flex justify-center gap-4 mb-6">
//         <button
//           className={`px-6 py-3 rounded-lg ${
//             view === "approved" ? "bg-green-600 text-[#fff5ec]" : "bg-gray-200"
//           }`}
...
//         <button
//           className={`px-6 py-3 rounded-lg ${
//             view === "pending" ? "bg-blue-600 text-[#fff5ec]" : "bg-gray-200"
//           }`}
...
//         {testimonials
//           .filter((t) => (view === "approved" ? t.approved : !t.approved))
//           .map((testimonial) => (
...
//               </div>
//               <button
//                 onClick={() => toggleApproval(testimonial._id)}
//                 className={`px-4 py-2 rounded-lg ${
//                   testimonial.approved ? "bg-red-500 text-[#fff5ec]" : "bg-green-500 text-[#fff5ec]"
//                 }`}
//               >
//                 {testimonial.approved ? "Revoke Approval" : "Approve"}
//               </button>
//             </div>
//           ))}
//       </div>
